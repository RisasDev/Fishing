package dev.risas.sukagepond.utilities.file;
...
public class FileConfig {
    ...
    public List<String> getStringListNoColor(String path) {
        return configuration.contains(path) ? configuration.getStringList(path) : Collections.singletonList("ERROR: STRING LIST NOT FOUND!");
    }
